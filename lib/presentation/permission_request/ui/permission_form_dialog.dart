        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              const Expanded(child: Text('Permission Request',
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Obx(() {
                  ...
                  return DropdownButtonFormField<String>(
                    value: safe,
                    isExpanded: true,
                    decoration: _deco(Icons.person_rounded, 'Select employee'),
                  ...
                  Padding(
                    ...
                    child: Icon(Icons.arrow_forward_rounded, size: 16,
                        color: fromTime != null && toTime != null
                            ? AppColors.info : AppColors.textMuted),
                  ),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (durationMinutes > 0) ...[
                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      const Icon(Icons.timer_rounded, size: 15, color: AppColors.info),
                ...
                TextFormField(
                  ...
                  decoration: _deco(Icons.notes_rounded, 'Enter reason for permission...'),
                ),
