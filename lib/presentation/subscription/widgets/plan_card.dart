...
class PlanCard extends StatelessWidget {
  ...
  const PlanCard(
      {super.key, required this.plan, required this.duration, required this.onSelect});
  ...
  Widget build(BuildContext context) {
    ...
    final price =
        duration == 'yearly' ? plan['yearly_price'] : plan['monthly_price'];
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text('Up to ${plan['user_limit']} users',
              style: TextStyle(
                  fontSize: 13,
                  color: isPro
                      ? Colors.white.withOpacity(0.8)
                ...
                child: Row(children: [
                  ...
                  Text(f,
                      style: TextStyle(
                          fontSize: 13,
                          color:
                              isPro ? Colors.white : AppColors.textSecondary)),
                ]),
              )),
          const SizedBox(height: 20),
          SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  disabledBackgroundColor:
                      isPro ? Colors.white.withOpacity(0.3) : AppColors.border,
                ),
                child: Text(isCurrentPlan ? 'Current Plan' : 'Get Started',
